...
using nlohmann::json;
using agilink::omnihand::service::HandRestClient;
...
int main(int argc, char** argv) {
  ...
  try {
    HandRestClient client(HandRestClient::Options{host, port});
    ...
    json hand_info = client.DescribeHand(hand_id);
    std::cout << "DescribeHand: " << hand_info.dump(2) << "\n";
