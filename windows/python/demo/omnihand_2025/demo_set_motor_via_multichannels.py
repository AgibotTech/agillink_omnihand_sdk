...
def main():
    left_hand = OmniHand2025.create_hand_by_zlgcan(canfd_device_id=0, hand_type=EHandType.LEFT, canfd_channel_id=0)
    right_hand = OmniHand2025.create_hand_by_zlgcan(canfd_device_id=0, hand_type=EHandType.RIGHT, canfd_channel_id=1)
