...
@Date: 2025-11-06
@Description: Python node to publish motor velocity commands (Omnihand2025Pro)
...
class MotorVelPublisher(Node):
    def __init__(self, hand_side):
        ...
        self.publisher = self.create_publisher(
            MotorVel,
            f'/omnihand/omnihand_pro_2025/{hand_side}/motor_vel_cmd',
            10
        )
        ...
        self.get_logger().info(f'{hand_side.capitalize()} Motor Velocity Publisher Node started (O12, 12 DOF)')
