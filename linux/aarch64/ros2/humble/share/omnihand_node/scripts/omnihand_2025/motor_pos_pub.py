...
@Date: 2025-11-06
@Description: Python node to publish motor position commands (Omnihand2025)
...
class MotorPosPublisher(Node):
    def __init__(self, hand_side):
        ...
        self.publisher = self.create_publisher(
            MotorPos,
            f'/omnihand/omnihand_2025/{hand_side}/motor_pos_cmd',
            10
        )
        ...
        self.get_logger().info(f'{hand_side.capitalize()} Motor Position Publisher Node started')
