...
class Metaclass_Int8MultiArrayStamped(type):
    """Metaclass of message 'Int8MultiArrayStamped'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__int8_multi_array_stamped
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__int8_multi_array_stamped
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__int8_multi_array_stamped
            cls._TYPE_SUPPORT = module.type_support_msg__msg__int8_multi_array_stamped
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__int8_multi_array_stamped
...
class Int8MultiArrayStamped(metaclass=Metaclass_Int8MultiArrayStamped):
    """Message class 'Int8MultiArrayStamped'."""
