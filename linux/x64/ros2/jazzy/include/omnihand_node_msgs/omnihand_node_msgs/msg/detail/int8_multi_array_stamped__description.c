  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static rosidl_type_hash_t hash = {1, {
      0xac, 0x4d, 0x41, 0x08, 0x51, 0x59, 0x8a, 0x22,
      0x01, 0xb7, 0x38, 0x15, 0x96, 0xa4, 0x8b, 0xd7,
      0xa7, 0xaf, 0xf0, 0xd6, 0x5a, 0x78, 0xfc, 0x19,
      0x24, 0xb5, 0xa1, 0xc4, 0x65, 0xa4, 0x08, 0x12,
    }};
  return &hash;
}
...
static char omnihand_node_msgs__msg__Int8MultiArrayStamped__TYPE_NAME[] = "omnihand_node_msgs/msg/Int8MultiArrayStamped";
...
static char omnihand_node_msgs__msg__Int8MultiArrayStamped__FIELD_NAME__header[] = "header";
static char omnihand_node_msgs__msg__Int8MultiArrayStamped__FIELD_NAME__layout[] = "layout";
static char omnihand_node_msgs__msg__Int8MultiArrayStamped__FIELD_NAME__data[] = "data";

static rosidl_runtime_c__type_description__Field omnihand_node_msgs__msg__Int8MultiArrayStamped__FIELDS[] = {
  {
    {omnihand_node_msgs__msg__Int8MultiArrayStamped__FIELD_NAME__header, 6, 6},
    {
  ...
  {
    {omnihand_node_msgs__msg__Int8MultiArrayStamped__FIELD_NAME__layout, 6, 6},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
  ...
  {
    {omnihand_node_msgs__msg__Int8MultiArrayStamped__FIELD_NAME__data, 4, 4},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription omnihand_node_msgs__msg__Int8MultiArrayStamped__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      {omnihand_node_msgs__msg__Int8MultiArrayStamped__TYPE_NAME, 44, 44},
      {omnihand_node_msgs__msg__Int8MultiArrayStamped__FIELDS, 3, 3},
    },
    {omnihand_node_msgs__msg__Int8MultiArrayStamped__REFERENCED_TYPE_DESCRIPTIONS, 4, 4},
  };
  if (!constructed) {
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *omnihand_node_msgs__msg__Int8MultiArrayStamped__get_individual_type_description_source(NULL),
