...
bool omnihand_msgs__msg__joint_state_int8__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("omnihand_msgs.msg._joint_state_int8.JointStateInt8", full_classname_dest, 50) == 0);
  }
  omnihand_msgs__msg__JointStateInt8 * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of JointStateInt8 */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("omnihand_msgs.msg._joint_state_int8");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "JointStateInt8");
