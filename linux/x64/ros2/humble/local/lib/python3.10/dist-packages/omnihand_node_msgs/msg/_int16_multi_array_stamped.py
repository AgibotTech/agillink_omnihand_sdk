...
class Metaclass_Int16MultiArrayStamped(type):
    """Metaclass of message 'Int16MultiArrayStamped'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('omnihand_node_msgs')
        except ImportError:
            import logging
            import traceback
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__int16_multi_array_stamped
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__int16_multi_array_stamped
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__int16_multi_array_stamped
            cls._TYPE_SUPPORT = module.type_support_msg__msg__int16_multi_array_stamped
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__int16_multi_array_stamped
...
class Int16MultiArrayStamped(metaclass=Metaclass_Int16MultiArrayStamped):
    """Message class 'Int16MultiArrayStamped'."""
