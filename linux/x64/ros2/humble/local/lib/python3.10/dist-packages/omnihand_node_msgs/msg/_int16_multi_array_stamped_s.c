...
bool omnihand_node_msgs__msg__int16_multi_array_stamped__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("omnihand_node_msgs.msg._int16_multi_array_stamped.Int16MultiArrayStamped", full_classname_dest, 72) == 0);
  }
  omnihand_node_msgs__msg__Int16MultiArrayStamped * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of Int16MultiArrayStamped */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("omnihand_node_msgs.msg._int16_multi_array_stamped");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Int16MultiArrayStamped");
