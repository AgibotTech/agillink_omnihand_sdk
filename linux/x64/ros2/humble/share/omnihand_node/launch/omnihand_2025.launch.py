...
Usage:
  ...
  # Right hand
  ros2 launch omnihand_node omnihand_2025.launch.py hand_type:=right

  # Custom configuration (parameter names match Python API)
  ros2 launch omnihand_node omnihand_2025.launch.py hand_type:=left hand_device_id:=1 canfd_device_id:=0 canfd_channel_id:=0

  # Both hands
  ros2 launch omnihand_node omnihand_2025.launch.py enable_both_hands:=true canfd_channel_id:=0 second_canfd_channel_id:=1
"""
