...
@Date: 2025-01-XX
@Description: Demo script for setting joint angles using SetJointAngles service (OmniHand Pro 2025)
"""
...
class SetJointAnglesDemo(Node):
    ...
    def __init__(self, hand_side='left'):
        ...
        """
        super().__init__('set_joint_angles_demo_o12')
        ...
        self.get_logger().info(f'{hand_side.capitalize()} Hand SetJointAngles Demo started (O12)')
