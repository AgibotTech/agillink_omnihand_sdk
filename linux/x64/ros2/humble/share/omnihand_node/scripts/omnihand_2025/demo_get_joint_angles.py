...
@Date: 2025-01-XX
@Description: Demo script for getting joint angles using GetJointAngles service (OmniHand 2025)
"""
...
class GetJointAnglesDemo(Node):
    ...
    def __init__(self, hand_side='left'):
        ...
        """
        super().__init__('get_joint_angles_demo')
        ...
        self.get_logger().info(f'{hand_side.capitalize()} Hand GetJointAngles Demo started')
